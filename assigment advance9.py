...
print('"I could eat apple all day, apple are my favorite fruit"'.partition('bananas'))
print('"I could eat apple all day, apple are my favorite fruit"'.rpartition('bananas'))
